...
<div class="footer bg-white py-4 d-flex flex-lg-column {{ Metronic::printClasses('footer', false) }}" id="kt_footer">
    ...
    <div class="{{ Metronic::printClasses('footer-container', false) }} d-flex flex-column flex-md-row align-items-center justify-content-between">
        ...
        <div class="nav nav-dark order-1 order-md-2">
            <a href="https://keenthemes.com/metronic" target="_blank" class="nav-link pr-3 pl-0">درباره ما</a>
            <a href="https://keenthemes.com/metronic" target="_blank" class="nav-link px-3">تیم</a>
            <a href="https://keenthemes.com/metronic" target="_blank" class="nav-link pl-3 pr-0">تماس با ما</a>
        </div>
    </div>
</div>
